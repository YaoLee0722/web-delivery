...
if ($re->paymetSuccess->Status){
  $sql2 = "select product,price,size,customer_name,dispatch,phone,count from ice_order where ispay=0 and customer_name='".$username."'";
  ...
  foreach ($result as $key=> $value) {
    ...
    $sql = "update ice_order set ispay=1 where ispay=0 and customer_name='".$username."'";
